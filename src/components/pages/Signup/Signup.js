...
import userimg5 from '../../../assets/images/user4.png';import CommonButton from '../../common/CommonButton/CommonButton';
...
const Signup = () => {
  ...
  const validationSchema = Yup.object({
    name: Yup.string().matches(/^[a-zA-Z ]*$/,"Name must contain letters and white spaces").required('This field is required'),
  ...
  const handleSubmit = (values, submitProps) => {
    ...
    try {
      http.post('/api/v1/auth/signup', body).then((res) => {
                      ...
                      <Row>
                        ...
                        <Col xs={12}>
                          <FormikControl
                            ...
                            className="mb-4"
                          />
                          {formik?.values?.password?.length < 7 && <p className={global.characterLimit}>
